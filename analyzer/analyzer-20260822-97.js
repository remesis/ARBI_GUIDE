(function () {
  ...
  function syncDashboardClearMapLayout(report) {
    ...
    if (!grid || !composition || !workspace || !workspaceTop || !clearMap || !activity) return;
    ...
    const compositionBottom = composition.getBoundingClientRect().bottom;
    ...
    const shouldSpanReport = compositionBottom < clearMapTop - Math.max(.5, scale);
