(function () {
  ...
  function renderComposition(run) {
    ...
    const heading = CORRELATION_LAYOUT_ACTIVE
      ? `<div class="composition-heading"><h3 class="card-title">Enemy composition</h3><span class="composition-despawns"><span>20s Drone despawns:</span><strong>${fmt(run.dronesDespawned || 0)}</strong></span></div>`
