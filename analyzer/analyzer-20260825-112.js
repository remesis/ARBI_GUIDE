(function () {
  ...
  function renderCorrelationCard(data) {
    ...
    const clientBlessingButton = data.canUseClientFreshBlessing
      ? `<button class="client-fresh-blessing-button${data.clientFreshBlessing ? " is-active" : ""}" type="button" data-client-fresh-blessing aria-pressed="${data.clientFreshBlessing}" data-html2canvas-ignore="true">Client had fresher blessing</button>`
      : "";
