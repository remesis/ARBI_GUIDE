(function () {
  ...
  function renderDroneClearEfficiency(run) {
    ...
    return `<section class="card kpi drone-clear-efficiency-kpi"><div class="drone-clear-stats"><div class="drone-clear-primary"><div class="kpi-label">Drone clear efficiency</div><div class="kpi-value">${h(efficiencyLabel)}</div></div><div class="drone-clear-secondary"><div class="kpi-value">${h(enemiesPerDroneLabel)}</div><div class="kpi-label">Enemies / Drone</div></div></div><div class="kpi-note drone-clear-note">${h(observedLabel)} observed · 20% Drone chance before 3/3 cap.</div></section>`;
  }
