...
import {isCombinedTrait, splicedTraitsFor} from './catalog.mjs?v=20260924-splice-baselines';
...
export function renderMath({catalog, research, target, variant, format, nameOf}) {
  ...
  <p><strong>Provisional splice ranges.</strong> Numeric entries from the <a href="https://wiki.warframe.com/w/Riven_Mods#Spliced_Values" target="_blank" rel="noopener noreferrer">wiki's Spliced Values table</a>, reviewed 24 September 2026, supply the supported baselines. The source still flags some values and names as placeholders. Ranges apply the selected disposition, format and grade band; display rounding is provisional. Missing weapon-type values and Parry Angle's unclear unit remain unknown. These entries are not added to ordinary cycling pools.</p>
