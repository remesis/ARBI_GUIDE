...
import {isCombinedTrait, splicedTraitsFor} from './catalog.mjs?v=20260924-splice-range-fallback';
...
export function renderMath({catalog, research, target, variant, format, nameOf}) {
  ...
  <p><strong>Provisional splice ranges.</strong> Numeric baselines from the <a href="https://wiki.warframe.com/w/Riven_Mods#Spliced_Values" target="_blank" rel="noopener noreferrer">wiki's Spliced Values table</a>, reviewed 24 September 2026, take priority. Only where an elemental or faction splice has no wiki value do we currently assume the corresponding ordinary-stat range for the selected weapon and variant, including its disposition, format, grade band and rounding. The wiki flags some values and names as placeholders, and their display rounding is provisional. Other missing weapon-type values and Parry Angle's unclear unit stay unknown. These entries are not added to ordinary cycling pools.</p>
