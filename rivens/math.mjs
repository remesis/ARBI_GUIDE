...
export function renderMath({catalog, research, target, variant, format, nameOf}) {
  ...
  <h3>9. Research status and references</h3>
  <p>This is an independent research reference, not an official probability table. Catalog date: ${esc(catalog.snapshot.date)}. Planned traits or unconfirmed behavior are not silently inserted into the catalog. A changed update, pool, or sampling procedure requires recalculation.</p>
  <p><a href="https://forums.warframe.com/topic/1521438-devshorts-115-116-a-look-at-riven-changes/" target="_blank" rel="noopener noreferrer">Digital Extremes: Riven changes announcement</a> provides update context, not a disclosure of the assumed RNG algorithm.</p>`;
}
